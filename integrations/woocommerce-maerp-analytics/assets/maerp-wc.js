/*
 * maERP WooCommerce glue — fires commerce funnel events on top of the core tracker.
 * Depends on window.maerpTrack (core) and, for add-to-cart, jQuery (shipped by WooCommerce).
 */
(function () {
  "use strict";
