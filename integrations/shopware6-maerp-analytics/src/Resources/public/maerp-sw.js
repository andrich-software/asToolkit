/*
 * maERP Shopware 6 glue — fires commerce funnel events on top of the core tracker.
 * Depends on window.maerpTrack (core). Best-effort detection via URL + add-to-cart form submits.
 */
(function () {
  "use strict";

  function track(type, extra) {
    if (window.maerpTrack && typeof window.maerpTrack.event === "function") {
      window.maerpTrack.event(type, extra || {});
    }
  }
