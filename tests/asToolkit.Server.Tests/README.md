# asToolkit.Server.Tests

## Übersicht

Dieses Test-Projekt enthält Integration Tests für die asToolkit.Server API mit besonderem Fokus auf Multi-Tenancy.
...
```bash
# Alle Tests
dotnet test tests/asToolkit.Server.Tests/

# Spezifische Test-Klasse
dotnet test tests/asToolkit.Server.Tests/ --filter "FullyQualifiedName~AiModelListQueryTests"

# Spezifischer Test
dotnet test tests/asToolkit.Server.Tests/ --filter "FullyQualifiedName~GetAiModels_WithValidTenant_ShouldReturnTenantSpecificModels"
```
