...
namespace asToolkit.Server.Tests;
...
public class TenantDtoSerializationTests
{
    ...
    public void TenantListDto_DeserializesExpectedProperties()
    {
        ...
        Assert.Equal("main.astoolkit.local", dto.Domain);
    ...
    public void TenantDetailDto_DeserializesAdditionalProperties()
    {
        const string json = """
        {
            ...
            "domain": "secondary.astoolkit.local"
        }
        """;
        ...
        Assert.Equal("secondary.astoolkit.local", dto.Domain);
