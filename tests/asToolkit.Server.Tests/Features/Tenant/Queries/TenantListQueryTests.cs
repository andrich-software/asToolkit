...
namespace asToolkit.Server.Tests.Features.Tenant.Queries;
    ...
    private async Task SeedUserTenantsAsync()
    {
        ...
        try
        {
            ...
            if (!hasUserTenants)
            {
                ...
                var userTenant1 = new asToolkit.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var userTenant2 = new asToolkit.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var user2Tenant1 = new asToolkit.Domain.Entities.UserTenant
                {
                    UserId = User2Id,
                    TenantId = TenantConstants.TestTenant1Id,
                    IsDefault = true,
