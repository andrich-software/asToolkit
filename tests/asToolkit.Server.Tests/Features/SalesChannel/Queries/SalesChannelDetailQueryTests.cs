...
namespace asToolkit.Server.Tests.Features.SalesChannel.Queries;
    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (existingSalesChannel == null)
            {
                ...
                var salesChannel1_1 = new asToolkit.Domain.Entities.SalesChannel
                {
                    ...
                    Warehouses = new List<asToolkit.Domain.Entities.Warehouse> { warehouse1, warehouse2 }
                };

                var salesChannel1_2 = new asToolkit.Domain.Entities.SalesChannel
                {
                ...
                var salesChannel2_1 = new asToolkit.Domain.Entities.SalesChannel
                {
