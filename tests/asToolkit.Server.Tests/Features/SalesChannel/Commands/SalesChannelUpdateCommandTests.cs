...
namespace asToolkit.Server.Tests.Features.SalesChannel.Commands;
    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (existingSalesChannel == null)
            {
                ...
                var warehouse1 = new asToolkit.Domain.Entities.Warehouse();
                var warehouse2 = new asToolkit.Domain.Entities.Warehouse();
                var warehouse3 = new asToolkit.Domain.Entities.Warehouse();

                if (existingWarehouse1 == null)
                {
                    warehouse1 = new asToolkit.Domain.Entities.Warehouse
                    {
                        Id = TestWarehouse1Id,
                    ...
                    warehouse2 = new asToolkit.Domain.Entities.Warehouse
                    {
                        Id = TestWarehouse2Id,
                    ...
                    warehouse3 = new asToolkit.Domain.Entities.Warehouse
                    {
                        Id = TestWarehouse3Id,
                ...
                var salesChannel1 = new asToolkit.Domain.Entities.SalesChannel
                {
                    ...
                    ExportSaless = false,
                    TenantId = TenantConstants.TestTenant1Id,
                    Warehouses = new List<asToolkit.Domain.Entities.Warehouse> { warehouse1 }
                };

                var salesChannel2 = new asToolkit.Domain.Entities.SalesChannel
                {
                ...
                var salesChannel3 = new asToolkit.Domain.Entities.SalesChannel
                {
                    ...
                    ExportSaless = true,
                    TenantId = TenantConstants.TestTenant2Id,
                    Warehouses = new List<asToolkit.Domain.Entities.Warehouse> { warehouse3 }
                };
