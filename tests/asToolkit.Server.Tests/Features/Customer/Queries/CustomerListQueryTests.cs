...
public class CustomerListQueryTests : TenantIsolatedTestBase
{
    ...
    private async Task SeedCustomerTestDataAsync()
    {
        ...
        var customer3Tenant1 = new asToolkit.Domain.Entities.Customer
        {
        ...
        var customer4Tenant2 = new asToolkit.Domain.Entities.Customer
        {
        ...
        var customer5Tenant2 = new asToolkit.Domain.Entities.Customer
        {
