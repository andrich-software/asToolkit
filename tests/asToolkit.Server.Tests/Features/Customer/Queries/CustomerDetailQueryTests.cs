...
namespace asToolkit.Server.Tests.Features.Customer.Queries;
...
public class CustomerDetailQueryTests : TenantIsolatedTestBase
{
    ...
    private async Task SeedCustomerTestDataAsync()
    {
        ...
        var customerAddress1 = new asToolkit.Domain.Entities.CustomerAddress
        {
        ...
        var customerAddress2 = new asToolkit.Domain.Entities.CustomerAddress
        {
