...
namespace asToolkit.Server.Tests.Features.Customer.Commands;
...
public class CustomerDeleteCommandTests : TenantIsolatedTestBase
{
    ...
    private async Task SeedCustomerTestDataAsync()
    {
        ...
        try
        {
            ...
            var customer1Tenant1 = new asToolkit.Domain.Entities.Customer
            {
                Id = Customer1Id,
                CustomerId = 1,
                Firstname = "John",
            ...
            var customer2Tenant1 = new asToolkit.Domain.Entities.Customer
            {
                Id = Customer2Id,
                CustomerId = 2,
                Firstname = "Jane",
            ...
            var customer3Tenant2 = new asToolkit.Domain.Entities.Customer
            {
                Id = Customer3Id,
                CustomerId = 3,
                Firstname = "Bob",
            ...
            var customer4Inactive = new asToolkit.Domain.Entities.Customer
            {
                Id = Customer4Id,
                CustomerId = 4,
                Firstname = "Alice",
            ...
            var customer5WithAddresses = new asToolkit.Domain.Entities.Customer
            {
                Id = Customer5Id,
                CustomerId = 5,
                Firstname = "Charlie",
            ...
            var customerAddress = new asToolkit.Domain.Entities.CustomerAddress
            {
