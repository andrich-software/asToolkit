...
namespace asToolkit.Server.Tests.Features.TenantEmailSettings;
...
public class TenantAwareEmailServiceFallbackTest
{
    ...
    private sealed class StubSettingsService : ISettingsService
    {
        ...
        public Task<asToolkit.Application.Models.Identity.JwtSettings> GetJwtSettingsAsync() => Task.FromResult(new asToolkit.Application.Models.Identity.JwtSettings());
        public Task<EmailSettings> GetEmailSettingsAsync() => Task.FromResult(_email);
        public Task<asToolkit.Application.Models.Telemetry.TelemetrySettings> GetTelemetrySettingsAsync() => Task.FromResult(new asToolkit.Application.Models.Telemetry.TelemetrySettings());
        public Task<asToolkit.Application.Models.Grafana.GrafanaSettings> GetGrafanaSettingsAsync() => Task.FromResult(new asToolkit.Application.Models.Grafana.GrafanaSettings());
        public Task<asToolkit.Application.Models.Analytics.ClickHouseSettings> GetClickHouseSettingsAsync() => Task.FromResult(new asToolkit.Application.Models.Analytics.ClickHouseSettings());
