...
namespace asToolkit.Server.Tests.Features.Invoice.Commands;
...
public class InvoiceUpdateCommandTests : IDisposable
{
    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var sales1 = new asToolkit.Domain.Entities.Sales
                {
                    Id = Sales1Id,
                    CustomerId = Customer1Id,
                    TenantId = TenantConstants.TestTenant1Id
                ...
                var sales2 = new asToolkit.Domain.Entities.Sales
                {
                    Id = Sales2Id,
                    CustomerId = Customer2Id,
                    TenantId = TenantConstants.TestTenant2Id
                ...
                var duplicateInvoiceTenant1 = new asToolkit.Domain.Entities.Invoice
                {
    ...
    public async Task UpdateInvoice_WithValidData_ShouldReturnUpdatedInvoiceId()
    {
        ...
        TestAssertions.AssertEqual(asToolkit.Domain.Enums.PaymentStatus.CompletelyPaid, updatedInvoice.PaymentStatus);
    }
