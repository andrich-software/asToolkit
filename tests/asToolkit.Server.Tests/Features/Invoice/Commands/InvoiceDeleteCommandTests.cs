    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var invoice2Tenant1 = new asToolkit.Domain.Entities.Invoice
                {
                    Id = Invoice2Id,
                ...
                var invoice3Tenant2 = new asToolkit.Domain.Entities.Invoice
                {
                    Id = Invoice3Id,
                ...
                var invoice4WithItems = new asToolkit.Domain.Entities.Invoice
                {
                    Id = Invoice4Id,
