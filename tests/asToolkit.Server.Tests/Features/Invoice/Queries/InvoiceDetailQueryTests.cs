...
namespace asToolkit.Server.Tests.Features.Invoice.Queries;
...
public class InvoiceDetailQueryTests : IDisposable
{
    ...
    private async Task SeedInvoiceTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var customer1 = new asToolkit.Domain.Entities.Customer
                {
                    Id = Guid.NewGuid(),
                ...
                var customer2 = new asToolkit.Domain.Entities.Customer
                {
                    Id = Guid.NewGuid(),
                ...
                var product1 = new asToolkit.Domain.Entities.Product
                {
                    Id = Product1Id,
                    Sku = "TEST-001",
                    Name = "Test Product 1",
                ...
                var product2 = new asToolkit.Domain.Entities.Product
                {
                    Id = Product2Id,
                    Sku = "TEST-002",
                    Name = "Test Product 2",
                ...
                var invoice1Tenant1 = new asToolkit.Domain.Entities.Invoice
                {
                    Id = Invoice1Id,
                    ...
                    TotalTax = 38.00m,
                    Total = 248.00m,
                    PaymentStatus = asToolkit.Domain.Enums.PaymentStatus.Invoiced,
                    InvoiceStatus = asToolkit.Domain.Enums.InvoiceStatus.Created,
                ...
                var invoice2Tenant2 = new asToolkit.Domain.Entities.Invoice
                {
                    Id = Invoice2Id,
                    ...
                    TotalTax = 19.00m,
                    Total = 119.00m,
                    PaymentStatus = asToolkit.Domain.Enums.PaymentStatus.CompletelyPaid,
                    InvoiceStatus = asToolkit.Domain.Enums.InvoiceStatus.Sent,
                    TenantId = TenantConstants.TestTenant2Id
                };

                DbContext.Invoice.AddRange(invoice1Tenant1, invoice2Tenant2);

                var invoiceItem1 = new asToolkit.Domain.Entities.InvoiceItem
                {
                    Id = InvoiceItem1Id,
                ...
                var invoiceItem2 = new asToolkit.Domain.Entities.InvoiceItem
                {
                    Id = InvoiceItem2Id,
                    InvoiceId = Invoice1Id,
                    ProductId = Product1Id,
    ...
    public async Task GetInvoiceDetail_ShouldIncludeAllBasicFields()
    {
        ...
        TestAssertions.AssertEqual(asToolkit.Domain.Enums.PaymentStatus.Invoiced, invoice.PaymentStatus);
        TestAssertions.AssertEqual(asToolkit.Domain.Enums.InvoiceStatus.Created, invoice.InvoiceStatus);
