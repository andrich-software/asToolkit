...
namespace asToolkit.Server.Tests.Features.Manufacturer.Queries;
    ...
    private async Task SeedManufacturerTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var manufacturer1Tenant1 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer1Id,
                ...
                var manufacturer2Tenant1 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer2Id,
                ...
                var manufacturer3Tenant1 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer3Id,
                    Name = "Gamma Corp",
                    City = "Chicago",
                ...
                var manufacturer4Tenant2 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer4Id,
                    Name = "Delta Systems",
                    City = "Berlin",
                ...
                var manufacturer5Tenant2 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer5Id,
                    Name = "Echo Solutions",
                    City = "Munich",
