...
namespace asToolkit.Server.Tests.Features.Manufacturer.Commands;
    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var manufacturer3Tenant2 = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer3Id,
                ...
                var manufacturerWithProducts = new asToolkit.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer5Id,
