    ...
    private async Task SeedProductTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var product1Tenant1 = new asToolkit.Domain.Entities.Product
                {
                    Id = Product1Id,
                    Sku = "TEST-001",
                    Name = "Test Product 1",
                ...
                var product2Tenant1 = new asToolkit.Domain.Entities.Product
                {
                    Id = Product2Id,
                    Sku = "TEST-002",
                ...
                var product3Tenant2 = new asToolkit.Domain.Entities.Product
                {
                    Id = Product3Id,
                    Sku = "TEST-003",
