...
using asToolkit.Application.Features.SalesChannelOAuth.Commands.OAuthCallback;
using asToolkit.Application.Features.SalesChannelOAuth.Commands.OAuthDisconnect;
using asToolkit.Application.Features.SalesChannelOAuth.Commands.OAuthStart;
...
public class SalesChannelOAuthController(IMediator mediator) : ControllerBase
{
        ...
        [FromQuery(Name = "error_description")] string? errorDescription)
    {
        ...
        return Html(success: true,
            $"Successfully connected {providerEnum}. You can close this tab and return to asToolkit.");
    }
