...
using asToolkit.Server.Filters;
...
public static class SwaggerRegistrationService
{
    public static IServiceCollection AddSwaggerServices(this IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "asToolkit.Server API",
                Version = "v1",
                Description = "RESTful API for asToolkit - Enterprise Resource Planning System",
                Contact = new OpenApiContact
                {
                    Name = "asToolkit",
                    Email = "support@astoolkit.de",
                    Url = new Uri("https://github.com/asToolkit")
                },
