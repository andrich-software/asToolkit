        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("66666666-6666-6666-6666-666666666615"), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3970), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3970), "Jwt.Issuer", "asToolkit.Server" },
                    { new Guid("66666666-6666-6666-6666-666666666616"), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3970), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3970), "Jwt.Audience", "asToolkit.Client" },
                    ...
                    { new Guid("66666666-6666-6666-6666-666666666621"), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3980), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3980), "Email.FromName", "asToolkit" },
                    ...
                    { new Guid("66666666-6666-6666-6666-666666666623"), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3990), new DateTime(2025, 9, 26, 19, 15, 28, 570, DateTimeKind.Utc).AddTicks(3990), "Telemetry.ServiceName", "asToolkit.Server" }
                });
