...
namespace asToolkit.Domain.Dtos.TenantEmailSettings;

/// <summary>
/// Detail DTO for the tenant-level email configuration.
/// Returned values mirror what is stored on the tenant — empty fields indicate inheritance from the server-level <see cref="asToolkit.Domain.Entities.Setting"/>.
/// </summary>
