...
namespace asToolkit.Infrastructure.EmailService;
...
<head>
    <meta charset='UTF-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
    <title>Willkommen bei asToolkit</title>
</head>
<body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;'>
    <div style='background-color: #f8f9fa; Border-radius: 10px; padding: 30px;'>
        <h1 style='color: #0066cc; margin-top: 0;'>Willkommen bei asToolkit!</h1>

        <p>Hallo {recipientName},</p>

        <p>Vielen Dank für Ihre Registrierung bei asToolkit. Wir freuen uns, Sie als neuen Benutzer begrüßen zu dürfen!</p>

        <p>Mit asToolkit haben Sie Zugriff auf eine umfassende ERP-Lösung für Ihr Unternehmen.</p>
        ...
        <ul style='padding-left: 20px;'>
            ...
            <li>Beginnen Sie mit der Nutzung von asToolkit</li>
        </ul>
